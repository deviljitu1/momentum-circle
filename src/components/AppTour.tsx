...
export const AppTour = () => {
    ...
    const getTooltipStyle = () => {
        ...
        if (placement === "bottom") {
            style = { top: targetRect.bottom + space, left: safeCenterX, x: "-50%" };
        } else if (placement === "top") {
            style = { bottom: screenH - targetRect.top + space, left: safeCenterX, x: "-50%" };
        } else if (placement === "left") {
            style = { top: targetRect.top + targetRect.height / 2, right: screenW - targetRect.left + space, y: "-50%" };
        } else if (placement === "right") {
            style = { top: targetRect.top + targetRect.height / 2, left: targetRect.right + space, y: "-50%" };
        } else {
